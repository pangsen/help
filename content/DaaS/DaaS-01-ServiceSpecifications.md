...
metaDescription: "本仕様書は、SoftBank株式会社がお客様向けに提供するSB Cloud Remote Desktopソリューションサービスにおいて、サービスの概要や基本サービスやオプションサービスの内容、本ソリューションを利用する上での責任範囲、注意制限事項等の仕様を記載した文書です。"
date: "2021-09-07"
...
本仕様書は、SoftBank株式会社がお客様向けに提供するSB Cloud Remote Desktopソリューションサービスにおいて、サービスの概要や基本サービスやオプションサービスの内容、本ソリューションを利用する上での責任範囲、注意制限事項等の仕様を記載した文書です。
...
| サービスプロバイダ |本サービスを提供する事業者。本仕様書ではSoftBank株式会社を指す|
...
「SBCloud Remote Desktopソリューション」は、SoftBankがサービスプロバイダとして、クラウドプラットフォーム上で利用者に仮想デスクトップを提供するサービスです。  
サービスには以下の2種類があります。
...
**•無制限モードへの切り替えは？**  
インスタンスタイプの変更で可能です。  
ご自身で操作できる場合はいつでも変更出ます。SoftBankに依頼する場合は、MSPをご契約いただきサービスクレジットを使って依頼することができます。  
...
**•SoftBankからMicrosoft Officeは購入可能ですか？**  
