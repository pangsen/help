...
![5.2.2.1.2](https://raw.githubusercontent.com/sbcloud/help/main/content/DaaS/images/DaaS-02-Portal-Manual/5.2.2.1.2-desktop-start-confirm.png)  
...
（３）追加方法は空のディスクを作成、あるいはスナップショットから作成をご選択ください。  
※本手順では空のディスクを作成を選択します。  
...
OKボタンを押下します。  
![5.4.2.3.2](https://raw.githubusercontent.com/sbcloud/help/main/content/DaaS/images/DaaS-02-Portal-Manual/5.4.2.3.2-user-delete-confirm.png)  
ユーザが正しく削除されたことを確認します。完了ボタンを押下します。  
![5.4.2.3.3](https://raw.githubusercontent.com/sbcloud/help/main/content/DaaS/images/DaaS-02-Portal-Manual/5.4.2.3.3-user-delete.png)
