...
![Enter Common Buy Page by Create Button](https://raw.githubusercontent.com/sbcloud/help/master/content/usecase-serverless/images/01_Enter_Common_Buy_Page_By_Create_Button.png「Enter Common Buy Page by Create Button」)をクリックします。
...
![サーバーレスK8Sクラスターでサポートされるイメージ](https://raw.githubusercontent.com/sbcloud/help/master/content/usecase-serverless/images/07_Supported_Images_In_Serverless_K8S_Cluster.png "Supported Images in Serverless K8S Cluster")
...
インスタンスにdockerサービスがインストールされ、正常に実行されていることを確認してください。\
...
![Create Secrets Successfully](https://raw.githubusercontent.com/sbcloud/help/master/content/usecase-serverless/images/29_Create_Secrets_Successfully.png "Create Secrets Successfully")と表示されます。

デプロイメントページ」に移動し、「画像から作成」ボタンをクリックして、デプロイ作業に入ります。
...
![Deployments - Complete Successfully](https://raw.githubusercontent.com/sbcloud/help/master/content/usecase-serverless/images/38_Deployments_Complete_Successfully.png "Deployments - Complete Successfully")と表示されます。
...
knativeがクラスタにデプロイされたら、それを使って[サービスの管理](https://www.alibabacloud.com/help/doc-detail/198683.htm)を行うことができます。
