...
![パーソナルエディションのインスタンス追加](https://raw.githubusercontent.com/ohiro18/ts.dev/master/content/usecase-serverless/images/08_Add_Instance_Of_Personal_Edition.png「パーソナルエディションのインスタンス追加」)
